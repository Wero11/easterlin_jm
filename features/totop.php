...
class HelixFeatureTotop {
	...
	{        
		 return '<a class="sp-totop" href="javascript:;" title="' . JText::_('GOTO_TOP') . '" rel="nofollow"><small>'. JText::_('GOTO_TOP') .' </small><i class="icon-angle-up"></i></a>';
	}    
}